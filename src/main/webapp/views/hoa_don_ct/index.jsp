            ...
            <ul>
                ...
                <c:forEach begin="0" end="${pageHC.totalPages-1}" var="page">
                    ...
                    <c:if test="${page ne pageHC.number}">
                        <a href="/hoa-don-ct/index?page=${page}&maSpct=${param.maSpct}">${page+1}</a>
                    </c:if>
                </c:forEach>
            </ul>
        </nav>
        ...
        <nav>
            <ul>
                ...
                <c:forEach begin="0" end="${pageHC.totalPages-1}" var="page">
                    ...
                    <c:if test="${page ne pageHC.number}">
                        <a href="/hoa-don-ct/index?page=${page}&ngayMuaHang=${param.ngayMuaHang}">${page+1}</a>
                    </c:if>
                </c:forEach>
            </ul>
        </nav>
        ...
        <nav>
            <ul>
                ...
                <c:forEach begin="0" end="${pageHC.totalPages-1}" var="page">
                    ...
                    <c:if test="${page ne pageHC.number}">
                        <a href="/hoa-don-ct/index?page=${page}">${page+1}</a>
                    </c:if>
                </c:forEach>
            </ul>
        </nav>
